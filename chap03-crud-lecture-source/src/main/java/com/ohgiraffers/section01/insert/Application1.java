...
public class Application1 {
    public static void main(String[] args) {
        ...
        /* 설명.
         *  DML(insert, update, delete) 작업 시에는 반환결과가 int값이 된다 (ResultSet을 쓰지 않는다)
         *  기존의 조회일 때는 executeQuery()를 사용했지만 DML 작업시에는 executeUpdate()를 사용함
        * */
        int result = 0;
        ...
        try {
             ...
             * */
            result = pstmt.executeUpdate();             // 자동 커밋 상태에서는 executeUpdate하면 자동 커밋한다 (수동 커밋 변환)
